...
export default function Landing() {
  ...
  return (
    <section className="before:content-[''] before:absolute before:bottom-0 before:w-full before:h-[100px] before:bg-gradient-to-t before:from-[#172527] before:to-transparent before:z-50 relative w-full h-screen overflow-hidden flex justify-center items-center">
      <div className="bg-[url('/img-landing/office.png')] bg-contain bg-top bg-repeat-x w-full h-full absolute top-0 left-0 pointer-events-none" id="bg"></div>
      ...
      <div className="bg-[url('/img-landing/hand.png')] bg-contain bg-bottom bg-repeat-x w-full h-screen absolute z-20" id="hand"></div>
      <div className="bg-[url('/img-landing/lamp.png')] bg-contain bg-top bg-repeat-x w-full h-screen absolute" id="lamp"></div>
      <div className="bg-[url('/img-landing/desk.png')] bg-contain bg-bottom bg-repeat-x w-full h-screen absolute z-30" id="desk"></div>
    </section>
  );
